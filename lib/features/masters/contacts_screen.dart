...
class _ContactsScreenState extends State<ContactsScreen> {
  ...
  Widget build(BuildContext context) => PageFrame(
        title: 'Parties',
        subtitle:
            'Customers, vendors, GST registrations and party master data.',
        actions: [
          IconButton(
              onPressed: _load,
              tooltip: 'Refresh',
              ...
              child: Wrap(
                ...
                SegmentedButton<String>(
                    segments: const [
                      ...
                      ButtonSegment(
                          value: 'CUSTOMER', label: Text('Customers')),
...
class _ContactDialogState extends State<_ContactDialog> {
  ...
  void initState() {
    ...
    _stateCode = TextEditingController(
        text:
            p['state_code']?.toString() ?? a['state_code']?.toString() ?? '27');
  ...
  Future<void> _save() async {
    ...
    try {
      final address = [_street, _city, _state, _pincode]
