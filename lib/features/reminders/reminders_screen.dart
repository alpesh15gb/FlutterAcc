...
class _RemindersScreenState extends State<RemindersScreen> {
  ...
  Widget build(BuildContext context) => PageFrame(
        ...
        subtitle:
            'Live overdue collection reminders and today’s sales, receipts and purchase/bill summary.',
        actions: [
            ...
            : _error != null
                ...
                : _items.isEmpty
                    ? const EmptyState(
                        ...
                        message:
                            'Live overdue reminders and the daily business summary will appear here.',
                      )
                    : Column(
                        children: _items.map((item) {
                          final title = '${item['title'] ?? 'Reminder'}';
                          final overdue =
                              title.toLowerCase().contains('overdue');
                          return Padding(
