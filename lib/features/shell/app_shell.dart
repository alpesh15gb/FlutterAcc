...
class _AppShellState extends State<AppShell> {
  ...
  Widget _screen() {
    ...
    return switch (_selected) {
      ...
      _ =>
        workspaceCatalog.containsKey(_selected)
            ? DataWorkspaceScreen(
                api: api,
                config: workspaceCatalog[_selected]!,
              )
        ...
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  widget.session.tenantName ?? 'ApexBooks',
          ...
          actions: [
            ...
            PopupMenuButton<String>(
              icon: CircleAvatar(
                ...
                child: Text(
                  _initials(
                    widget.session.userName ?? widget.session.userEmail ?? 'U',
                  ),
                ),
              ),
              onSelected: (v) {
