...
class _ComplianceToolsScreenState extends State<ComplianceToolsScreen>
  ...
  Widget build(BuildContext context) => PageFrame(
    ...
    subtitle: 'Live business reminders, GSTIN verification and HSN/SAC reference lookup.',
    child: Column(
      children: [
        SectionCard(
          child: TabBar(
...
class _GstinVerifyCardState extends State<_GstinVerifyCard> {
  ...
  Future<void> _verify() async {
    ...
    if (_sessionId == null || _captcha.text.trim().isEmpty) {
      showMessage(
        context,
        'Load the captcha and enter the displayed code.',
        error: true,
      );
      return;
    }
        ...
        Wrap(
          ...
          children: [
            ...
            OutlinedButton.icon(
              ...
              icon: const Icon(Icons.refresh_rounded),
              label: Text(
                _captchaImage == null ? 'Load captcha' : 'New captcha',
              ),
            ),
      ...
      children: [
        ...
        if (_result != null) ...[
          ...
          ListTile(
            ...
            subtitle: SelectableText(_result!['description']?.toString() ?? ''),
          ),
        ],
      ],
    ),
